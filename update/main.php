...
<body>
	...
	<table class="collections_content" style="background-color: ' . $colors[0] . ';" id="' . $collection . '">
		<td onclick="window.location='/update/collection/new/'">
			<h2 style="text-align: left; margin-left: 2%; color:' . $colors[1] . '; float: left;">Napravite Novi Skup</h2>
		</td>
	</table>
