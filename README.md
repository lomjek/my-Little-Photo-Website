...
### Why Apache2/php/d?
I know that there are shiny Frameworks and stuff, but I wanted to go with something established and well known. That is why I chose this setup. It is not a LAMP Server, more like LADP (Linux Apache D Php) Server. I know that D is not widely known but I like the syntax of the language.

## Hosting:
You will need to have a valid ldc installation. Either ldc or ldc2 via cli. For building of the targets you simply run the build script in the root directory in your shell.
