...
<body id="main">
	...
	<div id="iod_container">
		<img id="iod_img" onerror="handleImageError(this)" class="margin_10_px" src="<?php echo shell_exec($_SERVER['DOCUMENT_ROOT'] . '/libs/iod.dc'); ?>" alt="The Image of the Day could not be loaded.">
	</div>
	...
	<hr>
	<footer class="margin_10_px" onclick="window.location = 'https://github.com/lomjek/my-Little-Photo-Website'">This is Version 3.2 of the Image Website</footer>
</body>
