...
<html lang="hr">
    ...
    <body id="main">
        ...
        <hr>
        <h2 id="slikadana">Slika dana:</h2>
		<div>
			<h3 style="float: right;" onclick="window.location.assign('<?php echo get_iod(true); ?>')">Otvori u Skupu =></h3>
            <h3 id="iod_d">Ovdje ćete svaki dan vidjeti drugu sliku, koja je slika dana. Ovdje pronađite zanimljive slike koje inače ne biste vidjeli. Ove slike odabira programm, a može se tjekom dana isto promjeniti, ako se dodava slike ovoga dana. Uživajte!</h3>
			<img src="<?php echo get_iod(); ?>" id="iod" alt="The Image of the Day could not be loaded.">
		</div>
        <hr>
